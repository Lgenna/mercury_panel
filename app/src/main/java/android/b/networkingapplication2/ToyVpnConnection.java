...
//    private DashboardActivity vroom = new DashboardActivity();
    ...
    private boolean run(SocketAddress server) throws IOException, InterruptedException, IllegalArgumentException {
        ...
        QueryLogBaseHelper myQueDbDash;
...
//                if (length > 0) {
                    ...
                    // turn the packet into an ip address (ex: 000.000.000.000)
                    // instead of converting here, you could convert when its an ip you want and
                    //  compare hex values because it might be slightly faster / more efficient
...
//                    }
//
//                    // check to see if its a blocked address
////                    if (!something.toString().equals("144.208.64.112")) {
//
...
//
//                        myQueDbDash = DashboardActivity.getMyQueDb();
//
//                        if (myQueDbDash != null) {
//                            myQueDbDash.insertData(
//                                    "" + dateTime,
//                                    "" + output,
//                                    "Allowed");
//
//                            DashboardActivity.setMyQueDb(myQueDbDash);
//                        }
//                    }
                ...
                if (length > 0) {
                    ...
                    if (idle) {
                        ...
                        if (lastSendTime + KEEPALIVE_INTERVAL_MS <= timeNow) {
                            ...
                            throw new IllegalStateException("Timed out");               // CRASHES HERE!!!!
                        }
                    }
                }
            }
